...
// 1. Add Share2 to import if missing
...
// 2. Add handleShare before return (
if (!content.includes('handleShare = async () =>')) {
  const renderReturnRegex = /  return \(\n    <div className="w-full max-w-5xl/;
  ...
  return (
    <div className="w-full max-w-5xl`;
  content = content.replace(renderReturnRegex, shareCode);
}

// 3. Add to Download All block
if (!content.includes('title="Share this tool with colleagues"')) { // Ensure we don't double replace
