  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col gap-16 mt-16 pb-20">
      ...
      <section className="bg-surface-container-low p-8 md:p-12 rounded-3xl border border-white/5 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col gap-4 relative">
            ...
            <h3 className="font-bold text-white text-lg">{t('step1_title')}</h3>
          ...
          <div className="flex flex-col gap-4 relative">
            ...
            <h3 className="font-bold text-white text-lg">{t('step2_title')}</h3>
            <p className="text-on-surface-variant leading-relaxed">
              {t('step2_desc')}
            </p>
          </div>
          <div className="flex flex-col gap-4 relative">
            ...
            <h3 className="font-bold text-white text-lg">{t('step3_title')}</h3>
            <p className="text-on-surface-variant leading-relaxed">
              {t('step3_desc')}
            </p>
          </div>
      ...
      <section className="prose prose-invert prose-lg max-w-none">
        <h2 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight mb-6">{t('why_title')}</h2>
      ...
      <section className="bg-surface-container p-1 rounded-3xl border border-white/5 overflow-hidden">
        <div className="bg-surface-container-low p-8 md:p-10 rounded-[22px]">
          <h2 className="text-2xl font-extrabold text-white mb-6 tracking-tight">{t('bitrate_title')}</h2>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-on-surface">
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  <td className="py-4 px-4 font-bold text-white">128 kbps</td>
                ...
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  <td className="py-4 px-4 font-bold text-white">192 kbps</td>
                  <td className="py-4 px-4 text-on-surface-variant">AAC-LC</td>
                  <td className="py-4 px-4">{t('bitrate_192_use')}</td>
                  <td className="py-4 px-4 text-on-surface-variant">{t('bitrate_192_desc')}</td>
                </tr>
                <tr className="border-b border-white/5 bg-primary/5 hover:bg-primary/10 transition-colors">
                  <td className="py-4 px-4 font-bold text-primary">256 kbps</td>
                  <td className="py-4 px-4 text-on-surface-variant">AAC-LC</td>
                  <td className="py-4 px-4 font-semibold text-white">{t('bitrate_256_use')}</td>
                  <td className="py-4 px-4 text-on-surface-variant">{t('bitrate_256_desc')}</td>
                </tr>
                <tr className="hover:bg-white/5 transition-colors">
                  <td className="py-4 px-4 font-bold text-white">320 kbps</td>
                  <td className="py-4 px-4 text-on-surface-variant">AAC-LC</td>
      ...
      <section className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-surface-container-low p-6 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors">
            <Shield className="w-8 h-8 text-primary mb-4" />
            <h3 className="font-bold text-white text-lg mb-2">{t('feat1_title')}</h3>
            <p className="text-on-surface-variant">
          ...
          <div className="bg-surface-container-low p-6 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors">
            ...
            <h3 className="font-bold text-white text-lg mb-2">{t('feat2_title')}</h3>
            <p className="text-on-surface-variant">
          ...
          <div className="bg-surface-container-low p-6 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors">
            ...
            <h3 className="font-bold text-white text-lg mb-2">{t('feat3_title')}</h3>
            <p className="text-on-surface-variant">
              {t('feat3_desc')}
            </p>
          </div>
          <div className="bg-surface-container-low p-6 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors">
            ...
            <h3 className="font-bold text-white text-lg mb-2">{t('feat4_title')}</h3>
            <p className="text-on-surface-variant">
      ...
      <section className="flex flex-col gap-8 mb-12">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-surface-container-low p-6 md:p-8 rounded-2xl border border-white/5">
