  ...
  return (
    <div className="w-full md:w-2/3 bg-surface-container/80 backdrop-blur-2xl rounded-2xl border border-white/5 shadow-2xl relative overflow-hidden group p-6 md:p-10">
      ...
      <div className="relative w-full h-64">
        {status === 'idle' && (
          <div 
            className={`absolute inset-0 border-2 border-dashed rounded-xl flex flex-col items-center justify-center gap-4 cursor-pointer transition-all duration-300 group/drop bg-surface-dim/50
        ...
        {(status === 'processing' || status === 'done') && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-surface-dim/80 rounded-xl overflow-hidden border border-white/5">
             {/* Ambient Glow */}
        ...
        {status === 'error' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-surface-dim/95 rounded-xl border border-error/50 p-8 text-center z-20">
