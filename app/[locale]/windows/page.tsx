    ...
    <main className="flex-1 relative z-10 w-full max-w-7xl mx-auto px-6 py-12 flex flex-col gap-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
        <article className="prose prose-invert prose-orange max-w-none">
          ...
          <h3 className="text-xl font-bold text-white mt-8 mb-3">{t('article_h2')}</h3>
          <p className="text-slate-400 leading-relaxed mb-4">
            {t('article_p2_prefix')}{' '}
            <code className="bg-white/10 px-1 rounded text-emerald-400">
              {t('article_p2_code')}
            </code>{' '}
            {t('article_p2_suffix')}
          </p>

          <h3 className="text-xl font-bold text-white mt-8 mb-3">{t('article_h3')}</h3>
