  ...
  return (
    <main className="flex-1 relative z-10 w-full max-w-7xl mx-auto px-6 py-12 flex flex-col gap-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel p-6 rounded-2xl border border-outline-variant/10 flex flex-col gap-4">
          <div className="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center font-mono font-bold text-emerald-400">
            {t('step1_number')}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
        <article className="prose dark:prose-invert prose-orange max-w-none">
          ...
          <p className="text-on-surface-variant leading-relaxed mb-4">
            {t('article_p1_prefix')}
            <code className="bg-on-surface/10 px-1 rounded">{t('article_p1_code')}</code>
            {t('article_p1_suffix')}
          </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-surface-container-high/50 p-5 rounded-xl border border-outline-variant/10">
            <h4 className="font-bold text-on-surface mb-2 text-lg">{t('faq1_question')}</h4>
            <p className="text-on-surface-variant text-sm leading-relaxed">{t('faq1_answer')}</p>
          </div>
          <div className="bg-surface-container-high/50 p-5 rounded-xl border border-outline-variant/10">
            <h4 className="font-bold text-on-surface mb-2 text-lg">{t('faq2_question')}</h4>
            <p className="text-on-surface-variant text-sm leading-relaxed">{t('faq2_answer')}</p>
          </div>
          <div className="bg-surface-container-high/50 p-5 rounded-xl border border-outline-variant/10">
            <h4 className="font-bold text-on-surface mb-2 text-lg">{t('faq3_question')}</h4>
            <p className="text-on-surface-variant text-sm leading-relaxed">{t('faq3_answer')}</p>
          </div>
        </div>
      </div>
    </main>
