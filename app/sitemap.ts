...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: '/wav-to-mp3', priority: 0.9 },
    { path: '/mp3-to-wav', priority: 0.8 },
    { path: '/what-is-a-daw', priority: 0.8 },
    { path: '/blog', priority: 0.9 },
    { path: '/blog/what-is-a-daw', priority: 0.8 },
    { path: '/blog/sample-rate-vs-bit-depth', priority: 0.8 },
    { path: '/blog/lossless-vs-lossy-audio', priority: 0.8 },
