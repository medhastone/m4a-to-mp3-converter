          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="border-b border-white/10 text-on-surface-variant">
                <th className="p-4 font-semibold">Bitrate Preset</th>
                <th className="p-4 font-semibold">Codec / Mode</th>
                <th className="p-4 font-semibold">Frequency Cutoff</th>
                <th className="p-4 font-semibold">File Size Ratio (vs 24-bit)</th>
                <th className="p-4 font-semibold">Recommended Use Case</th>
              </tr>
            </thead>
            <tbody className="bg-surface-container/30 text-sm text-on-surface">
              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                <td className="p-4 font-bold text-white">320kbps CBR</td>
                <td className="p-4 text-on-surface-variant">LAME Constant</td>
                <td className="p-4">~20.0 kHz</td>
                <td className="p-4">~ 1:6</td>
                <td className="p-4 text-on-surface-variant">DJ sets, studio masters, critical listening</td>
              </tr>
              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                <td className="p-4 font-bold text-white">VBR V0</td>
                <td className="p-4 text-on-surface-variant">LAME Variable</td>
                <td className="p-4">~19.5 kHz</td>
                <td className="p-4">~ 1:7</td>
                <td className="p-4 text-on-surface-variant">High fidelity mobile listening, optimal space saving</td>
              </tr>
              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                <td className="p-4 font-bold text-white">256kbps CBR</td>
                <td className="p-4 text-on-surface-variant">LAME Constant</td>
                <td className="p-4">~18.5 kHz</td>
                <td className="p-4">~ 1:8</td>
                <td className="p-4 text-on-surface-variant">Standard podcast distribution, iTunes equivalent</td>
              </tr>
              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                <td className="p-4 font-bold text-white">192kbps CBR</td>
                <td className="p-4 text-on-surface-variant">LAME Constant</td>
                <td className="p-4">~17.0 kHz</td>
                <td className="p-4">~ 1:11</td>
                <td className="p-4 text-on-surface-variant">Web streaming, background music for video</td>
              </tr>
              <tr className="hover:bg-white/5 transition-colors">
                <td className="p-4 font-bold text-white">128kbps CBR</td>
                <td className="p-4 text-on-surface-variant">LAME Constant</td>
                <td className="p-4">~16.0 kHz</td>
                <td className="p-4">~ 1:16</td>
                <td className="p-4 text-on-surface-variant">Voiceover drafts, compact email attachments</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-surface-container p-6 rounded-2xl border border-emerald-500/20 hover:border-emerald-500/40 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-white">Our Client-Side Tool</h3>
            </div>
          ...
          <div className="bg-surface-container p-6 rounded-2xl border border-red-500/20 hover:border-red-500/40 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-white">Traditional Cloud Tools</h3>
            </div>
            <ul className="space-y-4 text-sm text-on-surface-variant">
      ...
      <section className="bg-surface-container-low p-8 md:p-12 rounded-3xl border border-white/5 shadow-lg">
        ...
        <div className="space-y-6">
          <div className="flex gap-4 p-4 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
            ...
            <div>
              <h4 className="text-lg font-bold text-white mb-2">Music Producers & Mixing Engineers</h4>
          ...
          <div className="flex gap-4 p-4 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
            ...
            <div>
              <h4 className="text-lg font-bold text-white mb-2">Podcasters & Voiceover Artists</h4>
              <p className="text-on-surface-variant text-sm leading-relaxed">
          ...
          <div className="flex gap-4 p-4 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
            ...
            <div>
              <h4 className="text-lg font-bold text-white mb-2">Game & App Developers</h4>
              <p className="text-on-surface-variant text-sm leading-relaxed">
