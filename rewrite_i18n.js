...
const pages = [
  'windows', 'client-side-safe', 'batch-converter', 'about', 
  'iphone-voice-memos', 'privacy-policy', '320kbps', 'terms', 'mac'
];
...
async function main() {
  ...
  fs.writeFileSync('extracted_keys.json', JSON.stringify(allEnKeys, null, 2));
  console.log('Done!');
}
